...
hub_subnets = {
  default = {
    name                                       = "hub"
    address_prefixes                           = ["10.0.128.224/26"]
...
# By default, this module will not create a identity spoke.
deploy_identity_spoke = false

# Identity Virtual Network Parameters
# Uncomment the following section to enable Identity Management Spoke Virtual Network
/* id_name               = "id"
